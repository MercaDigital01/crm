...
const STATUS_ROWS = [
  ...
  { icon: ShieldCheck, label: "Tu cuenta", level: "Activo", tint: "bg-md-blue/10 text-md-blue" },
];
...
export default function Home() {
  return (
    <div className="flex flex-1 flex-col bg-white">
      ...
      <section className="relative overflow-hidden">
        <div className="relative min-h-[640px] w-full md:min-h-[760px]">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(17,24,39,0.55) 0%, rgba(17,24,39,0.68) 45%, rgba(17,24,39,0.95) 92%)",
            }}
          />

          <div className="relative mx-auto flex h-full max-w-6xl flex-col justify-end px-6 pb-16 pt-24 md:pb-20">
            <h1 className="max-w-3xl text-6xl font-semibold leading-[0.95] tracking-tight text-white sm:text-7xl md:text-[6rem]">
              Tu mercadotecnia,
              <br />
              <span className="text-md-teal">siempre a la vista.</span>
            </h1>
      ...
      <section className="border-b border-gray-100 bg-gray-50 px-6 py-20 md:py-24">
        <div className="mx-auto max-w-6xl">
          <div className={`rounded-3xl bg-white p-6 md:p-10 ${CARD_SHADOW}`}>
            <div className="mb-8 flex items-center justify-between">
              ...
              <span className="flex items-center gap-2 rounded-full bg-md-teal/10 px-3 py-1 text-xs font-medium text-md-teal">
      ...
      <section id="servicios" className="border-b border-gray-100 px-6 py-24 md:py-32">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-14 max-w-2xl text-4xl font-semibold leading-tight tracking-tight text-gray-900 md:text-5xl">
            Contenido, campañas y ventas — en un solo equipo.
          </h2>

          <div className="grid grid-cols-1 gap-6 md:grid-cols-5">
            {/* Agente — featured, wider */}
            <div className={`overflow-hidden rounded-3xl bg-gray-50 md:col-span-3 ${CARD_SHADOW}`}>
            ...
            {/* Ads — gold tint */}
            <div className={`flex flex-col gap-4 rounded-3xl bg-md-gold/[0.06] p-8 md:col-span-2 ${CARD_SHADOW}`}>
              <TrendingUp size={24} strokeWidth={1.75} className="text-[#a5790a]" />
            ...
            {/* Contenido — blue tint */}
            <div className={`flex flex-col gap-4 rounded-3xl bg-md-blue/[0.05] p-8 md:col-span-2 ${CARD_SHADOW}`}>
              <CalendarDays size={24} strokeWidth={1.75} className="text-md-blue" />
              <h3 className="text-xl font-semibold text-gray-900">
            ...
            <div className="flex items-center gap-4 rounded-3xl border border-gray-100 p-6 md:col-span-3">
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-md-blue/10">
                <span className="h-2 w-2 rounded-full bg-md-blue" />
              </span>
              <p className="text-sm leading-relaxed text-gray-500">
                Todo esto se refleja en tu{" "}
                <span className="font-medium text-gray-900">tablero</span>,
      ...
      <section id="proceso" className="bg-gray-50 px-6 py-24 md:py-32">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-16 max-w-xl text-4xl font-semibold leading-tight tracking-tight text-gray-900 md:text-5xl">
            Cómo arrancamos.
          </h2>
      ...
      <section className="bg-md-teal px-6 py-24 md:py-28">
        <div className="mx-auto flex max-w-6xl flex-col items-start gap-7">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 rounded-full bg-white px-7 py-3.5 text-sm font-semibold text-md-teal transition-transform duration-200 hover:scale-[1.02] active:scale-[0.97]"
            >
              Escribir por WhatsApp
            </a>
            <a
              href="mailto:mercadigital.durango@gmail.com"
              className="inline-flex items-center gap-3 rounded-full border border-white/40 px-7 py-3.5 text-sm font-semibold text-white transition-colors hover:border-white/70 active:scale-[0.97]"
            >
      ...
      <footer className="border-t border-gray-100 px-6 py-10">
        <div className="mx-auto flex max-w-6xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
            <Link
              href="/#servicios"
              className="text-xs font-medium uppercase tracking-wide text-gray-400 transition-colors hover:text-gray-900"
            >
              Servicios
            </Link>
            <Link
